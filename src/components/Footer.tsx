      ...
      <div className="section-shell">
        <div className="flex flex-col items-center gap-8 text-center md:flex-row md:items-start md:justify-between md:text-left">
          ...
          <div className="flex gap-4">
            <a href={whatsappHref} target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full border border-[#2A2A2A] text-[#B0B0B0] transition-all duration-300 hover:border-[#C8A33A] hover:text-[#C8A33A]">
            ...
            <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full border border-[#2A2A2A] text-[#B0B0B0] transition-all duration-300 hover:border-[#C8A33A] hover:text-[#C8A33A]">
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="mt-8 text-center md:hidden">
          <p className="text-sm italic text-[#C8A33A]">
            &ldquo;Calidad que se siente, confianza que se cultiva.&rdquo;
          </p>
        </div>
        ...
        <div className="mt-8 border-t border-[#2A2A2A] pt-6 text-center">
          <p className="text-xs text-[#707070]">
            &copy; 2026 The Golden Green. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
